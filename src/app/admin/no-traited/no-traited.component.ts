...
@Component({
  selector: 'app-no-traited',
  templateUrl: './no-traited.component.html',
  styleUrls: ['./no-traited.component.css']
})
export class NoTraitedComponent implements OnInit,OnDestroy,AfterViewInit{
